...
The table above presents the results of an OLS regression estimating the effects of digital access on poverty levels, while controlling for corruption, education, and urban/rural residence. I used Claude for this section to learn about how the coefficients change in the presence of an interaction term.
